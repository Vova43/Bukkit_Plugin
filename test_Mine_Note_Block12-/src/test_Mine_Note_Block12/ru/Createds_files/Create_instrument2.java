...
public class Create_instrument2 {
	public void onCreate_file(String path){
		...
		if (!file.exists()) {
			...
			try (FileOutputStream fos = new FileOutputStream(file)) {
				...
				fos.write("8=entity.blaze.hurt>-0.1,\n".getBytes());
				fos.write("9=entity.experience_orb.pickup>-0.4000,\n".getBytes());
				fos.write("10=entity.experience_orb.pickup>-0.4000,\n".getBytes());
				fos.write("11=entity.experience_orb.pickup>-0.4000,\n".getBytes());
				fos.write("12=entity.experience_orb.pickup>-0.4000,\n".getBytes());
				...
				fos.write("52=entity.zombie.infect>-0.4000,\n".getBytes());
				...
				fos.write("112=entity.zombie.infect>-0.4000,\n".getBytes());
				...
				fos.write("122=weather.rain.above>-0.5000,\n".getBytes());
				fos.write("123=entity.zombie.infect>-0.4000,\n".getBytes());
				fos.write("124=entity.zombie.infect>-0.4000,\n".getBytes());
				fos.write("125=weather.rain.above>-0.5000,\n".getBytes());
				fos.write("126=weather.rain.above>-0.5000,\n".getBytes());
